...
HashTable::HashTable(uint32_t hashSize, uint32_t indexSize): m_HashSize(hashSize), m_HashMask(0), m_IndexSize(indexSize), m_Hash(EmptyHash), m_NextIndex(nullptr) {
    // 确保哈希表的大小大于0且是2的幂次方
    CHECK(m_HashSize > 0);
...
HashTable::HashTable(HashTable&& other) noexcept: m_HashSize(other.m_HashSize), m_HashMask(other.m_HashMask), m_IndexSize(other.m_IndexSize), m_Hash(other.m_Hash), m_NextIndex(other.m_NextIndex) {
    other.m_HashSize  = 0;
    other.m_HashMask  = 0;
    other.m_IndexSize = 0;
